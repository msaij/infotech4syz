...
export default function ProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await authFetch('/api/v1/company/users/');
      if (!response.ok) {
      ...
      const updateResponse = await authFetch(`/api/v1/company/users/${userProfile.id}/`, {
        method: 'PUT',
        headers: {
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              disabled={loading}
              className="bg-black text-white px-4 py-2 rounded-lg font-semibold hover:bg-gray-800 transition text-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-sm text-gray-600">
                    {user.company_short_name?.toUpperCase() || 'Company Account'}
                  </span>
                </div>
              </div>
            </div>
